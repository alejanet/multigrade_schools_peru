...
* dependencies
	* add required packages/commands
    local ssc_install   "savesome winsor2  estout spmap shp2dta mif2dta"
...
* **********************************************************************
* 1 - Deciding if you want to update ado files (otherwise set adoUpdate to 0)
* **********************************************************************
